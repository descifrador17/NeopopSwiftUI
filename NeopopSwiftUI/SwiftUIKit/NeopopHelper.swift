...
public struct NeopopHelper {
    ...
    public static func primary50_plunk_button_model(style: StandardButtons.Style) -> NeopopButtonModel {
        return NeopopButtonModel(buttonHeight: 50, buttonWidth: UIScreen.main.bounds.width - 60, leftImage: nil, rightImage: style.arrowImage(), fontName: "NotoSansMyanmar-Bold", fontSize: 14, fontColor: style.textColor(), backgroundColor: style.bgColor(), edgeThickness: 3, edgeColor: style.edgeColor(), borderWidth: nil, borderColor: nil, loadingLottieName: style.loadingLottie(), buttonDirection: .bottomRight)
    }
    
    public static func primary40_plunk_button_model(style: StandardButtons.Style) -> NeopopButtonModel {
        return NeopopButtonModel(buttonHeight: 40, buttonWidth: UIScreen.main.bounds.width - 60, leftImage: nil, rightImage: style.arrowImage(), fontName: "NotoSansMyanmar-Bold", fontSize: 12, fontColor: style.textColor(), backgroundColor: style.bgColor(), edgeThickness: 3, edgeColor: style.edgeColor(), borderWidth: nil, borderColor: nil, loadingLottieName: style.loadingLottie(), buttonDirection: .bottomRight)
    }
    
    //MARK: Primary Flat Buttons
    public static func primary50_flat_button_model(style: StandardButtons.Style) -> NeopopButtonModel {
        return NeopopButtonModel(buttonHeight: 50, buttonWidth: UIScreen.main.bounds.width - 60, leftImage: nil, rightImage: style.arrowImage(), fontName: "NotoSansMyanmar-Bold", fontSize: 14, fontColor: style.textColor(), backgroundColor: style.bgColor(), edgeThickness: 10, edgeColor: style.edgeColor(), borderWidth: nil, borderColor: nil, loadingLottieName: style.loadingLottie(), buttonDirection: .bottomRight)
    }
    ...
    public static func primary30_flat_button_model(style: StandardButtons.Style) -> NeopopButtonModel {
        return NeopopButtonModel(buttonHeight: 30, buttonWidth: UIScreen.main.bounds.width - 60, leftImage: nil, rightImage: style.arrowImage(), fontName: "NotoSansMyanmar-Bold", fontSize: 10, fontColor: style.textColor(), backgroundColor: style.bgColor(), edgeThickness: 3, edgeColor: style.edgeColor(), borderWidth: nil, borderColor: nil, loadingLottieName: style.loadingLottie(), buttonDirection: .bottomRight)
    }
